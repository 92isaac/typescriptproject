      ...
      <div className="mt-6 rounded-md p-4 shadow-md">
        ...
        <div className="mt-4">
          ...
          <div className="mt-4">
            <div className="flex justify-between ">
              <div className="border py-1 px-4 rounded-md">
                <button
                  className="w-10 h-10 p-2 rounded-full text-center"
                  onClick={() => setOrderPro((prev) => prev - 1)}
                  disabled={orderPro < 1 ? true : false}
                >
                  -
                </button>
              ...
              <h3 className="font-bold p-3">
                <span className="text-base text-gray-300">Stock:</span>{" "}
                {order?.stock}
              </h3>
            </div>
          </div>
          ...
          <div className="mt-5 block shadowbotom pb-6">
            <button
              className="w-full mb-2 bg-[#2A977D] text-white rounded-md"
              onClick={() => navigate("/cart")}
            >
              Buy Now
            </button>
            <button
              className="w-full mb-2 border-[#2A977D] text-[#2A977D] hover:border-[#2A977D]"
              onClick={() => {
                console.log("Cliked me");
                dispatch(addToCart);
              }}
            >
              <FaShoppingBag className="inline" /> Add to Cart
            </button>
          </div>

          <div className="my-6">
            <button className="bg-inherit px-2 border-0">
              {" "}
              <FiMessageSquare className="inline" /> Chat Seller{" "}
            </button>
            <button className="bg-inherit px-2 border-0">
              {" "}
              <FiShare2 className="inline" /> Share Product{" "}
            </button>
          </div>
          ...
          <p className="text-xs text-gray-400">
            ...
            <span className="ml-2">
              <FaFlag className="inline" /> Report
            </span>{" "}
          </p>
        </div>
      </div>
